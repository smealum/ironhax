...
Handle* const dspHandle = (Handle*)IRON_DSP_HANDLE;
...
Result (* const _DSP_UnloadComponent)(Handle* handle) = (void*)IRON_DSP_UNLOADCOMPONENT;
Result (* const _DSP_RegisterInterruptEvents)(Handle* handle, Handle event, u32 type, u32 port) = (void*)IRON_DSP_REGISTERINTERRUPTEVENTS;
